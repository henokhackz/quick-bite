...
import { ticketHolders} from "@/lib/dummy";
...
const StudentListPage = () => {
  const renderRow = (item: TicketHolder) => (
    ...
    >
      ...
      <td className="hidden md:table-cell">{item.assignedCafteria}</td>
      <td>
  ...
  return (
    <div className="bg-white p-4 rounded-md flex-1 m-4 mt-4">
      ...
      <div className="flex items-center justify-between">
        <h1 className="hidden md:block text-lg font-semibold">All Ticket Holders</h1>
      ...
      {/* LIST */}
      <Table columns={columns} renderRow={renderRow} data={ticketHolders}/>
      {/* PAGINATION */}
      <Pagination />
    </div>
  );
